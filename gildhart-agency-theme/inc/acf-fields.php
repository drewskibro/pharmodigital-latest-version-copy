...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array(
            'key'           => 'field_gh_system_card_01_badge',
            'label'         => 'Card 01 — Claude badge',
            'name'          => 'system_card_01_badge',
            'type'          => 'image',
            'return_format' => 'id',
            'preview_size'  => 'thumbnail',
            'instructions'  => 'Upload "Powered by Claude Cowork" badge. Renders top-left of card 01 at 180px max width.',
        ),
        array(
            'key'           => 'field_gh_system_card_02_badge',
            'label'         => 'Card 02 — Claude badge',
            'name'          => 'system_card_02_badge',
            'type'          => 'image',
            'return_format' => 'id',
            'preview_size'  => 'thumbnail',
            'instructions'  => 'Upload "Powered by Claude Cowork" badge. Renders top-left of card 02 at 180px max width.',
        ),
        array(
            'key'           => 'field_gh_system_card_03_badge',
            'label'         => 'Card 03 — Claude badge',
            'name'          => 'system_card_03_badge',
            'type'          => 'image',
            'return_format' => 'id',
            'preview_size'  => 'thumbnail',
            'instructions'  => 'Upload "Built with Claude" badge. Renders top-left of card 03 at 180px max width.',
        ),
        array(
            'key'           => 'field_gh_system_card_04_badge',
            'label'         => 'Card 04 — Claude badge',
            'name'          => 'system_card_04_badge',
            'type'          => 'image',
            'return_format' => 'id',
            'preview_size'  => 'thumbnail',
            'instructions'  => 'Upload "Built with Claude" badge. Renders top-left of card 04 at 180px max width.',
        ),
        array(
            'key'           => 'field_gh_system_card_05_badge',
            'label'         => 'Card 05 — Claude badge',
            'name'          => 'system_card_05_badge',
            'type'          => 'image',
            'return_format' => 'id',
            'preview_size'  => 'thumbnail',
            'instructions'  => 'Upload "Built with Claude" badge. Renders top-left of card 05 at 180px max width.',
        ),
        array(
            ...
            'sub_fields' => array(
                ...
                array( 'key' => 'field_gh_service_wyg_module_label',    'label' => 'Step Label (gold caps)', 'name' => 'label',           'type' => 'text', 'instructions' => 'e.g. "Step 01 — Onboarding".' ),
                ...
                // Legacy fields preserved so historical saved data on the
                // Playbook post doesn't get orphaned. Not rendered.
                array( 'key' => 'field_gh_service_wyg_module_hook',  'label' => 'Hook Line (deprecated)',     'name' => 'hook',       'type' => 'text', 'instructions' => 'No longer rendered.' ),
                array( 'key' => 'field_gh_service_wyg_module_stat',  'label' => 'Proof — Stat (deprecated)',  'name' => 'proof_stat', 'type' => 'text', 'instructions' => 'No longer rendered.' ),
                array( 'key' => 'field_gh_service_wyg_module_ptxt',  'label' => 'Proof — Text (deprecated)',  'name' => 'proof_text', 'type' => 'textarea', 'rows' => 2, 'instructions' => 'No longer rendered.' ),
            ),
        ),
    ),
    'location' => array( array( array( 'param' => 'post_type', 'operator' => '==', 'value' => 'service' ) ) ),
