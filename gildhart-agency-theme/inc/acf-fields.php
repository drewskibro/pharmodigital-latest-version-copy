...
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        array(
            ...
            'default_value' => 'Get The Playbook — £1,995 →',
        ),
        array(
...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array( 'key' => 'field_gh_service_cta_label',  'label' => 'Button Label', 'name' => 'service_cta_label',  'type' => 'text', 'instructions' => 'Default: "Get The Playbook — £1,995". The → arrow is added automatically.' ),
    ...
    function gh_service_system_default_modules() {
        return array(
            array(
                ...
                'icon'             => 0,
                'badge'            => 0,
                'label'            => "What's Inside — 01",
                'title'            => 'The Pillar Domination Framework™',
                'subtitle'         => 'The exact architecture. Not a summary. The full system.',
                'body'             => 'Every content structure, every topic cluster, every entity relationship we run across 50+ live practices. One broad authority pillar, four supporting clusters, internally linked the way AI models actually read as expertise. The same framework that put Ealing above Boots in six weeks — mapped step by step, ready to deploy.',
                'stat_value'       => '',
                'stat_descriptor'  => '',
                'is_closer'        => 0,
            ),
            array(
                ...
                'icon'             => 0,
                'badge'            => 0,
                'label'            => "What's Inside — 02",
                'title'            => 'The Full Engine. Installed In Your Workspace.',
                'subtitle'         => 'The complete system, wired up and ready — not a blank prompt box.',
                'body'             => "The entire content engine pre-loaded into your Cowork Project and connected to your clinical knowledge base. A systematised, repeatable workflow that produces the same standard every time. You don't start with a blank page. You start with the finished system.",
                'stat_value'       => '',
                'stat_descriptor'  => '',
                'is_closer'        => 0,
            ),
            ...
            array(
                ...
                'icon'             => 0,
                'badge'            => 0,
                'label'            => "What's Inside — 04",
                'title'            => 'The AI Visibility Method',
                'subtitle'         => 'Know where you stand — and exactly what to publish next.',
                'body'             => 'A structured repeatable process for checking whether you\'re being recommended across ChatGPT, Claude, Perplexity, and Google AI Overviews. You test the questions that matter to your practice, see where you\'re named, and know the next move to compound it.',
                'stat_value'       => '',
                'stat_descriptor'  => '',
                'is_closer'        => 0,
            ),
            array(
                ...
                'icon'             => 0,
                'badge'            => 0,
                'label'            => "What's Inside — 05",
                'title'            => 'Direct-To-Site Publishing',
                'subtitle'         => "It doesn't hand you content. It publishes it.",
                'body'             => 'The engine connects straight to your WordPress. Drafts written, featured images set, SEO meta written, schema injected — on your site, in your voice. Everything lands behind a human sign-off gate. You approve before the world sees it. Full automation. Zero loss of control.',
                'stat_value'       => '',
                'stat_descriptor'  => '',
                'is_closer'        => 0,
            ),
            array(
                ...
                'icon'             => 0,
                'badge'            => 0,
                'label'            => "What's Inside — 06",
                'title'            => 'Monthly Strategy Calls + Lifetime Access',
                'subtitle'         => "The system evolves. Your access doesn't expire.",
                'body'             => 'Monthly group calls with Drew — not a support ticket, not a help doc. Every session covers what\'s shifting across the AI platforms and exactly what to do about it. You stay ahead because you\'re in the room where it\'s being figured out. Lifetime access across one practice or fifty, no per-seat fees, no expiry. Ealing spent £1,995. Then made £99k from one service. You get the keys. Forever.',
                'stat_value'       => '',
                'stat_descriptor'  => '',
                'is_closer'        => 1,
            ),
...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array(
            'key'           => 'field_gh_system_built_with_badge',
            'label'         => 'Built with Claude badge (header)',
            'name'          => 'system_built_with_claude_badge',
            'type'          => 'image',
            'return_format' => 'id',
        ...
        array(
            ...
            'instructions' => 'Cards render in a 2-column grid. Toggle "Full-width closer" on the last card to give it the section-spanning treatment.',
            'sub_fields' => array(
                array(
                    'key' => 'field_gh_service_wyg_module_kind', 'label' => 'Icon Glyph (fallback)', 'name' => 'icon_kind',
                    'type' => 'select', 'default_value' => 'menu',
                    'choices' => array(
                        'menu'       => 'Menu / service selection',
                        'library'    => 'Library / knowledge base',
                        'cycle'      => 'Cycle / automated workflow',
                        'engagement' => 'Engagement / content reading',
                        'dashboard'  => 'Dashboard / live tracking',
                    ),
                    'instructions' => 'Used when no Icon image is uploaded. Drives the brand SVG fallback for the card.',
                ),
                array(
                    'key' => 'field_gh_service_wyg_module_icon', 'label' => 'Icon Image (optional)', 'name' => 'icon',
                    'type' => 'image', 'return_format' => 'id', 'preview_size' => 'thumbnail',
                    'instructions' => 'Optional transparent PNG/SVG icon. Renders at 60×60. Leave empty to use the brand-aligned SVG fallback above.',
                ),
                array(
                    'key' => 'field_gh_service_wyg_module_badge', 'label' => 'Claude badge (optional)', 'name' => 'badge',
                    'type' => 'image', 'return_format' => 'id', 'preview_size' => 'thumbnail',
                    'instructions' => 'Per-card "Powered by Claude Cowork" / "Built with Claude" badge. Renders top-left of the card at 180px. Each card now carries its own badge — reordering cards keeps badges attached.',
                ),
                array( 'key' => 'field_gh_service_wyg_module_label',    'label' => 'Step Label (gold caps)', 'name' => 'label',           'type' => 'text', 'instructions' => 'e.g. "What\'s Inside — 01".' ),
                array( 'key' => 'field_gh_service_wyg_module_title',    'label' => 'Title',                  'name' => 'title',           'type' => 'text' ),
                array( 'key' => 'field_gh_service_wyg_module_subtitle', 'label' => 'Subtitle (italic)',      'name' => 'subtitle',        'type' => 'text' ),
                array( 'key' => 'field_gh_service_wyg_module_body',     'label' => 'Body',                   'name' => 'body',            'type' => 'textarea', 'rows' => 5 ),
                array( 'key' => 'field_gh_service_wyg_module_stat_val', 'label' => 'Stat Value',             'name' => 'stat_value',      'type' => 'text', 'instructions' => 'Big gold figure at the bottom of the card.' ),
                array( 'key' => 'field_gh_service_wyg_module_stat_dsc', 'label' => 'Stat Descriptor',        'name' => 'stat_descriptor', 'type' => 'text', 'instructions' => 'Small text beside / below the stat value.' ),
                array(
                    'key' => 'field_gh_service_wyg_module_is_closer', 'label' => 'Full-width Closer', 'name' => 'is_closer',
                    'type' => 'true_false', 'default_value' => 0, 'ui' => 1,
                    'instructions' => 'When on, this card spans the full row width with a richer background. Use on the last card only.',
                ),
            ),
        ),
    ),
...
/* Service · The Window (formerly a four-part Offer block — Parts
 * 02-04 retired once the dedicated Playbook Checkout section took
 * over the offer mechanics). Slug + group key preserved for ACF
 * data + metabox position continuity. */
acf_add_local_field_group( array(
    'key'        => 'group_gh_service_early_buyers',
    'title'      => 'Service · The Window',
    'menu_order' => 8,
    'fields'     => array(
        array(
        ...
        array( 'key' => 'field_gh_service_offer_window_eyebrow',  'label' => 'Eyebrow',  'name' => 'service_offer_window_eyebrow',  'type' => 'text' ),
        array( 'key' => 'field_gh_service_offer_window_headline', 'label' => 'Headline', 'name' => 'service_offer_window_headline', 'type' => 'text' ),
        array( 'key' => 'field_gh_service_offer_window_subhead',  'label' => 'Gold Italic Subhead', 'name' => 'service_offer_window_subhead', 'type' => 'text' ),
        array(
        ...
        array( 'key' => 'field_gh_service_offer_window_closer', 'label' => 'Bold Closing Line', 'name' => 'service_offer_window_closer', 'type' => 'textarea', 'rows' => 2 ),
    ),
    'location' => array( array( array( 'param' => 'post_type', 'operator' => '==', 'value' => 'service' ) ) ),
) );
...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array(
            'key'           => 'field_gh_service_fcp_tst_show',
            'label'         => 'Testimonial — Show',
            'name'          => 'service_fluclinic_tst_show',
            'type'          => 'true_false',
            'default_value' => 1,
            'ui'            => 1,
            'instructions'  => 'Sits between the screenshot and the closing line. Five gold stars are always shown above the quote.',
        ),
        array( 'key' => 'field_gh_service_fcp_tst_quote', 'label' => 'Testimonial — Quote', 'name' => 'service_fluclinic_tst_quote', 'type' => 'textarea', 'rows' => 4 ),
        array(
            'key'           => 'field_gh_service_fcp_tst_photo',
            'label'         => 'Testimonial — Headshot',
            'name'          => 'service_fluclinic_tst_photo',
            'type'          => 'image',
            'return_format' => 'id',
            'preview_size'  => 'thumbnail',
            'instructions'  => 'Circular-cropped headshot shown left of the name. Any square-ish image works — it is masked to a circle. Leave empty to show the name only.',
        ),
        array( 'key' => 'field_gh_service_fcp_tst_name', 'label' => 'Testimonial — Name', 'name' => 'service_fluclinic_tst_name', 'type' => 'text' ),
        array( 'key' => 'field_gh_service_fcp_tst_role', 'label' => 'Testimonial — Title', 'name' => 'service_fluclinic_tst_role', 'type' => 'text' ),
        array( 'key' => 'field_gh_service_fcp_prestats', 'label' => 'Line Above Stats', 'name' => 'service_fluclinic_prestats', 'type' => 'textarea', 'rows' => 2, 'instructions' => 'One reinforcing line shown between the closing paragraph and the stat bar.' ),
        array(
...
acf_add_local_field_group( array(
    ...
    'fields'     => array(
        ...
        array( 'key' => 'field_gh_aty_upsell_subhead',  'label' => 'Playbook Upsell — Subhead',  'name' => 'agent_thank_you_upsell_subhead',  'type' => 'textarea', 'rows' => 2, 'instructions' => 'Default: "The AI Search Playbook — the exact system that drove Ealing\'s £99k HPV revenue to their agent."' ),
        ...
        array( 'key' => 'field_gh_aty_upsell_cta_label', 'label' => 'Playbook Upsell — CTA Label', 'name' => 'agent_thank_you_upsell_cta_label', 'type' => 'text', 'instructions' => 'Default: "Get the Playbook — £1,995 →".' ),
