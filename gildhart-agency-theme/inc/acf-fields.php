        ...
        array(
            ...
            'sub_fields' => array(
                array(
                    ...
                    'label'         => 'Hero Card (Dark Forest Green Treatment)',
                    'name'          => 'is_featured',
                    'type'          => 'true_false',
                    'instructions'  => 'Mark exactly one card as Hero. Hero cards get the dark fill, gold inner border, gold ribbon, and reversed gold-button CTA.',
                    'default_value' => 0,
                    'ui'            => 1,
                ),
                array(
                    'key'           => 'field_gh_home_tp_card_ribbon',
                    'label'         => 'Hero Ribbon Text',
                    'name'          => 'ribbon_text',
                    'type'          => 'text',
                    'instructions'  => 'Gold pill ribbon at the top of the hero card. Small caps. Only renders when "Hero Card" is on. Example: DEPLOYED IN 7 DAYS · 50+ PRACTICES LIVE',
                ),
                array(
