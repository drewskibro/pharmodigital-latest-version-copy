...
(function () {
  ...
  reveal( '.founder-section',     'founder-visible', { threshold: 0.15, rootMargin: '0px 0px -60px 0px' } );
  reveal( '.revenue-section',     'rev-visible',    { threshold: 0.08, rootMargin: '0px 0px -40px 0px' } );
